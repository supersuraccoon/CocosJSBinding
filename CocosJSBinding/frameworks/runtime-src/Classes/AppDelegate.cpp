...
bool AppDelegate::applicationDidFinishLaunching()
{
    ...
    if(!glview) {
        ...
        glview = cocos2d::GLViewImpl::create("CocosJSBinding");
#else
        glview = cocos2d::GLViewImpl::createWithRect("CocosJSBinding", Rect(0,0,960,640));
#endif
...
#endif
    // custom
    sc->addRegisterCallback(register_all_glue_js_cc);
